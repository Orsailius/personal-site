<script lang="ts">
    ...
    import {findByName} from '$lib/data/birthdayPokemonList';

    export let pokemonName:string = "";
    export let images:string[] = [];

    let pokemon:any = findByName(pokemonName);

    let optionNames = ["A","B","C","D","E"];

</script>

<div class="flex outline outline-2 outline-gray-600 p-2 m-2 rounded-xl gap-2 bg-orange-100">
